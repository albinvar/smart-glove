<!-- Grid -->
<div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6" wire:poll.500ms>
    <!-- Card -->
    <div class="flex flex-col gap-y-3 lg:gap-y-5 p-4 md:p-5 bg-white border shadow-sm rounded-xl dark:bg-neutral-900 dark:border-neutral-800">
        <div class="inline-flex justify-center items-center">
            ...
            <span class="text-sm font-semibold uppercase text-gray-600">APPLIANCE 1</span>
        </div>

        @if ($appliance1->status == 1)
            <div class="text-center">
                <h3 class="text-3xl sm:text-4xl lg:text-5xl font-semibold text-green-800">
                    ON
                </h3>
            </div>
        @else
            <div class="text-center">
                <h3 class="text-3xl sm:text-4xl lg:text-5xl font-semibold text-red-800">
                    OFF
                </h3>
            </div>
        @endif
    ...
    <div class="flex flex-col gap-y-3 lg:gap-y-5 p-4 md:p-5 bg-white border shadow-sm rounded-xl dark:bg-neutral-900 dark:border-neutral-800">
        <div class="inline-flex justify-center items-center">
            ...
            <span class="text-sm font-semibold uppercase text-gray-600">APPLIANCE 2</span>
        </div>

        @if ($appliance2->status == 1)
            <div class="text-center">
                <h3 class="text-3xl sm:text-4xl lg:text-5xl font-semibold text-green-800">
                    ON
                </h3>
    ...
    <div class="flex flex-col gap-y-3 lg:gap-y-5 p-4 md:p-5 bg-white border shadow-sm rounded-xl dark:bg-neutral-900 dark:border-neutral-800">
        <div class="inline-flex justify-center items-center">
            ...
            <span class="text-xs font-semibold uppercase text-gray-600 dark:text-neutral-400">Appliance 3</span>
        </div>
